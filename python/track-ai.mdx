...
Inside a [`bento.begin(...)`](/python/trajectories) block, `track_ai` calls become children of the trajectory instead — the whole multi-step turn renders as one trace.
