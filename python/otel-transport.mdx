...
description: "The lower-level surface. Wire BentoLabs into an existing OpenTelemetry pipeline."
icon: "cube"
---
...
See [attribute mapping](/concepts/attribute-mapping) for the full table.
