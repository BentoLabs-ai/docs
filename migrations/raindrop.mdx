...
The skill carries the full migration playbook — finding your Raindrop call sites, installing Bento alongside, translating each construct, verifying traces land, then removing Raindrop. The rest of this page is the same translation guide if you'd rather do it by hand.
